...
# print(x)
with open("./xmv6_twentyeight_data_1.csv", "r") as ifile:
...
plt.ylabel("Sensor Reading (XMEAS[10])")
plt.xlabel("Observation Points")
plt.title("Observation Points vs Original Readings for 4800 obervations in SA2 ")
plt.show()
