...
# print(x)
with open("./xmeas10_001_data_1.csv", "r") as ifile:
...
plt.ylabel("Sensor Reading (XMEAS[9])")
plt.xlabel("Observation Points")
plt.title("Observation Points vs Original Readings for 4800 obervations in SA3 ")
plt.show()
